...
class View extends \Kotchasan\KBase
{
    ...
    public function index()
    {
        ...
        $data2 .= 'header.header,body.welcomepage,.language-menu li>a:hover,.topmenu>ul ul>li.hover>a,.topmenu>ul ul>li:hover>a,.gdpanel a:hover{background-color:'.self::$cfg->bg_color.'}';
